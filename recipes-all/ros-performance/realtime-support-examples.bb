...
#EXTRA_OECMAKE += " -DCMAKE_INSTALL_PREFIX=/usr/bin "
...
SRC_URI = "file://install-exec.patch file://find-correct-lib.patch git://github.com/ros2/realtime_support.git;branch=crystal"
...
DEPENDS += " realtime-support "
RDEPENDS_${PN} += " realtime-support "
